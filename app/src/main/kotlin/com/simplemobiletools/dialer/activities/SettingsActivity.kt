...
import com.simplemobiletools.dialer.SkyflowActivity
...
class SettingsActivity : SimpleActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settings_skyflow__customization_holder.setOnClickListener {
            startActivity(Intent(this,SkyflowActivity::class.java))
        }
    }
